  ...
  opts = {
    ...
    mappings = {
      n = {
        ...
        ["<Leader>lc"] = { "<Cmd>Lspsaga incoming_calls<CR>", desc = "Lspsaga incoming_calls" },
        ["<Leader>lC"] = { "<Cmd>Lspsaga outgoing_calls<CR>", desc = "Lspsaga outgoing_calls" },
        ...
        ["<Leader>lg"] = { "<Cmd>Lspsaga goto_definition<CR>", desc = "Lspsaga goto_definition" },
        ["<Leader>li"] = { "<Cmd>Lspsaga finder imp<CR>", desc = "Lspsaga find_imp" },
        ["<Leader>lr"] = { "<Cmd>Lspsaga finder ref<CR>", desc = "Lspsaga find_ref" },
        ["<Leader>lp"] = { "<Cmd>Lspsaga peek_definition<CR>", desc = "Lspsaga peek_definition" },
        ["<Leader>ln"] = { "<Cmd>Lspsaga rename mode=n<CR>", desc = "Lspsaga rename" },
